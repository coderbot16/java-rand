...
impl Random {
	...
	/// Sets the seed to `seed`. This is equivalent to
	...
	///
	/// # Panics
	/// If the requested bits is over 48, this function panics. Use next_i64/next_u64 instead, or multiple calls.
	...
	///
	/// # Panics
	/// If `max` is less than 1 (signed comparison), the function panics.
